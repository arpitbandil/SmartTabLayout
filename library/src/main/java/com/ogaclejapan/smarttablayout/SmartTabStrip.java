...
class SmartTabStrip extends LinearLayout {
    ...
    private static final int DEFAULT_HORIZONTAL_INDICATOR_GRAVITY = GRAVITY_CENTER;
    ...
    private final int indicatorHorizontalGravity;
    ...
    SmartTabStrip(Context context, AttributeSet attrs) {
        ...
        int indicatorHorizontalGravity = DEFAULT_HORIZONTAL_INDICATOR_GRAVITY;
        ...
        indicatorHorizontalGravity = a.getInt(
                R.styleable.stl_SmartTabLayout_stl_indicatorHorizontalGravity, indicatorHorizontalGravity);
        ...
        this.indicatorHorizontalGravity = indicatorHorizontalGravity;
